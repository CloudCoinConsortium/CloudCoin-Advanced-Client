...
public class CoinUtils {
    ...
    /**
     * Returns the index matching the denomination value.
     *
     * @param denomination denomination value
     * @return 0, 1, 2, 3, 4, 5, 6, or -1 if the index is invalid.
     */
    public static int getDenominationIndex(int denomination, boolean skip0) {
        for (int i = 0, j = denominations.length; i < j; i++)
    ...
    public static char[] consoleReport(CloudCoin cc) {
        ...
        //  SimpleLogger.QuickLog("Finished detecting coin index " + j);
